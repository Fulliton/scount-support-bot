...
@Middleware(StateMiddleware, [StateEnum.TOBACCO_STAGE_1])
@Message()
...
@Middleware(StateMiddleware, [StateEnum.TOBACCO_STAGE_2])
@Message()
...
@Middleware(StateMiddleware, [StateEnum.TOBACCO_STAGE_3])
@Message()
...
@Middleware(StateMiddleware, [StateEnum.TOBACCO_STAGE_4])
@Message()
...
@Middleware(StateMiddleware, [StateEnum.TOBACCO_STAGE_5])
@Message()
...
@Middleware(StateMiddleware, [StateEnum.TOBACCO_STAGE_6])
@Message()
